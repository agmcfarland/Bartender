...
def make_small_input_1(test_path):
	...
	df_experimental.to_csv(pjoin(test_path, 'experimental_samples_small_input_1.csv'), index = None)
...
def make_small_input_2(test_path):
	...
	df_experimental.to_csv(pjoin(test_path, 'experimental_samples_small_input_2.csv'), index = None)



def test_ete_first_run(test_path, make_workdir, test_workdir, make_small_input_1, make_small_input_2):
	"""
...
def test_ete_with_stock_record(test_path, make_workdir, test_workdir, make_small_input_1, make_small_input_2):
	make_small_input_1
	make_small_input_2
	make_workdir
	...
	# temp write record
	bartender_setup.record.stock.to_csv(pjoin(test_workdir, 'record', 'stock.csv'), index = None)
...
def test_ete_experimental(test_path, make_workdir, test_workdir, make_small_input_1, make_small_input_2):
	"""
