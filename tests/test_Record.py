...
def test_load_records_pass(mock_run_paths, stock_record, experimental_record, expected_experimental_output, expected_stock_output):
	"""
...
def test_update_records_pass(mock_run_paths, stock_record, experimental_record, expected_experimental_output, expected_stock_output):
	"""
	...
	with patch('pandas.read_csv') as mock_read_csv:
		...
		with patch('os.path.exists') as mock_path_exists:
			...
			expected_experimental_df = pd.concat([df_test_experimental, expected_experimental_output])
...
def test_update_records_fails_R1(mock_run_paths, stock_record, experimental_record, expected_experimental_output, expected_stock_output):
	"""
...
def test_update_records_fails_R2(mock_run_paths, stock_record, experimental_record, expected_experimental_output, expected_stock_output):
	"""
...
def test_update_records_fails_non_unique_sample(mock_run_paths, stock_record, experimental_record, expected_experimental_output, expected_stock_output):
	"""
	...
	with patch('pandas.read_csv') as mock_read_csv:
		...
		with patch('os.path.exists') as mock_path_exists:
			...
			with pytest.raises(ValueError, match = 'sample_name_standard_sample_name must must be unique'):
