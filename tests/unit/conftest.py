    ...
    return pd.DataFrame(
        {
            ...
            "input_template": [1000, 1000, 1000],
            "R1": [
                "path/to/stock1_R1.fastq.gz",
                "path/to/stock2_R1.fastq.gz",
                "path/to/stock3_R1.fastq.gz",
            ],
            "R2": [
                "path/to/stock1_R2.fastq.gz",
                "path/to/stock2_R2.fastq.gz",
                "path/to/stock3_R2.fastq.gz",
            ],
        }
    )
    ...
    return pd.DataFrame(
        {
            ...
            "input_template": [1000, 1000, 1000],
            "R1": [
                "path/to/stock4_R1.fastq.gz",
                "path/to/stock5_R1.fastq.gz",
                "path/to/stock6_R1.fastq.gz",
            ],
            "R2": [
                "path/to/stock4_R2.fastq.gz",
                "path/to/stock5_R2.fastq.gz",
                "path/to/stock6_R2.fastq.gz",
            ],
    ...
    return pd.DataFrame(
        {
            ...
            "genetic_source": ["dna", "dna", "dna"],
            "R1": [
                "path/to/sample4_R1.fastq.gz",
                "path/to/sample5_R1.fastq.gz",
                "path/to/sample6_R1.fastq.gz",
            ],
            "R2": [
                "path/to/sample4_R2.fastq.gz",
                "path/to/sample5_R2.fastq.gz",
                "path/to/sample6_R2.fastq.gz",
            ],
            "standard_sample_name": [
                "group1_plasma_0_blood_dna",
                "group2_plasma_3_blood_dna",
                "group3_plasma_4_blood_dna",
            ],
        }
    )
